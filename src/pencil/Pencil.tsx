...
const Pencil: React.FC<Props> = ({ width, ref, opacity = 1 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 156.57 54.24" width={width} ref={ref} opacity={opacity}>
